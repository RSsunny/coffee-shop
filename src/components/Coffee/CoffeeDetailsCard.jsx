...
const CoffeeDetailsCard = () => {
  ...
  return (
    <div
      className="bg-cover bg-center py-5 md:py-20"
      style={{ backgroundImage: `url("${bgDetails}")` }}
    >
      <div className="py-5 md:py-10 max-w-7xl mx-auto ">
        <Link
          to={"/"}
          className="text-xl text-black font-bold px-4 py-2 hover:bg-[#D2B48C] rounded-md"
        >
          Back to home
        </Link>
      </div>
      <div className="text-black flex flex-col md:flex-row justify-center md:gap-20  items-center p-20 max-w-7xl mx-auto px-5 bg-[#F4F3F0] ">
        <div>
