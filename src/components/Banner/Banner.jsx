    ...
    return (
        <div className="bg-cover bg-center flex justify-end items-center py-2 h-[500px] object-cover " style={{backgroundImage:`url("${bannerImg}")`}}>
            <div className="mr-10 lg:mr-32">
                ...
                <p className="w-[500px]  mb-5">Its coffee time - Sip & Savor - Relaxation in every sip! Get the nostalgia back!! Your companion of every moment!!! Enjoy the beautiful moments and make them memorable.</p>
