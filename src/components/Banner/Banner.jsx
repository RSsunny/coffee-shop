    ...
    return (
        <div className="bg-cover bg-center flex justify-end items-center py-2 h-[500px] object-cover " style={{backgroundImage:`url("${bannerImg}")`}}>
            <div className="md:mr-10 lg:mr-32 px-2">
                <h1 className="md:text-4xl  mb-5 font-rancho">Would you like a Cup of Delicious Coffee?</h1>
                ...
                <Link to={'/'} className="px-4 md:px-6 py-2 bg-[#E3B577]  hover:bg-transparent hover:border font-rancho text-black hover:text-white text-xl">Learn More</Link>
            </div>
