    ...
    >
      <div className="max-w-7xl mx-auto px-5 text-black ">
        <div className="py-5 md:py-10 font-rancho">
          <Link
            to={"/"}
            className="text-3xl text-black  px-4 py-2 hover:bg-[#D2B48C] rounded-md "
          >
            Back to home
          </Link>
        </div>
        <form
          ...
          className="bg-[#F4F3F0] md:p-16 p-5 mb-10 md:mb-20"
        >
          <div className="text-center">
            <h1 className="text-3xl md:text-5xl font-rancho">Add New Coffee</h1>
            <p className="lg:w-[700px] mx-auto my-5 text-xs md:text-base">
          ...
          <div className="md:flex gap-5 justify-center items-center w-full ">
            <label htmlFor="name" className="w-1/2">
              <h1>Name</h1>
              <input
                className="w-full p-2 my-4 outline-none"
                type="text"
                name="name"
                id=""
